...
# YS: speakql
def beam_search_with_heuristics_for_speakql(model, speakql_input, orig_item, preproc_item, beam_size, max_steps, from_cond=True):
    """
    Copied from beam_search_with_heuristics, adding speakql_input argument
    """
    inference_state, next_choices = model.begin_inference(speakql_input)
