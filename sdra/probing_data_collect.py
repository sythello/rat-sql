...
def collect_probing_dataset(args,
    ...
    for sample_ds_idx in tqdm(sample_ds_indices, ascii=True):
        ...
        X, y, pos = pb_utils.extract_probing_samples_link_prediction_ratsql(
...
def main(args):
    rat_sql_model_dict = Load_Rat_sql(root_dir=args.ratsql_root_dir,
    ...
    db_schemas_dict = pb_utils.precompute_spider_schemas_dict(
