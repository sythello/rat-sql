...
class LinkPredictionDataCollector_ratsql_spider(LinkPredictionDataCollector_ratsql, LinkPredictionDataCollector_spider):
    # no extra functions needed for now
    pass


class LinkPredictionDataCollector_ratsql_wikisql(LinkPredictionDataCollector_ratsql, LinkPredictionDataCollector_wikisql):
    # no extra functions needed for now
    pass
